...
model_run = ens_run -1
ohca_later =Dataset("../../../../../data/cmip-thorne/ssp370_ohca.nc", 'r').variables['__xarray_dataarray_variable__']
...
df_co2_model = pd.read_csv("../../../../../data/cmip-thorne/ERF_ESM1-2-LR_ssp370.csv")
