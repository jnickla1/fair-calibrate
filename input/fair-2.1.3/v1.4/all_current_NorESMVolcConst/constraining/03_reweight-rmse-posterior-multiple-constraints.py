...
ohca_later = Dataset("../../../../../data/cmip-thorne/rcp45VolcConst_partial20_ohca.nc", 'r').variables['__xarray_dataarray_variable__']
...
df_co2_model = pd.read_csv("../../../../../data/cmip-thorne/ERF_NorESM_rcp45VolcConst_full.csv")
