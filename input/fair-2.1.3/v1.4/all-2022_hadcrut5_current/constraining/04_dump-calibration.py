...
f.allocate()
trend_shape = np.ones((2024-1750+1))
...
f.run() #unclear if we need to run here
ghgs = [
 'CO2','CH4','N2O',
...
np.save(f"../../../../../output/collect/{constraint_set}_temp_anthro", temp_anthro)
np.save(f"../../../../../output/collect/{constraint_set}_temp_all", temp_all)
np.save(f"../../../../../output/collect/{constraint_set}_temp_nonat", temp_nonat)
