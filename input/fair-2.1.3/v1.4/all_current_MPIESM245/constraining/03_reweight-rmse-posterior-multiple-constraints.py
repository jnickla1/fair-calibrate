...
model_run = ens_run-1
ohca_later =Dataset("../../../../../data/cmip-thorne/ssp245_ohca.nc", 'r').variables['__xarray_dataarray_variable__']
...
df_co2_model = pd.read_csv("../../../../../data/cmip-thorne/ERF_ESM1-2-LR_ssp245.csv")
samples["CO2 concentration"] = scipy.stats.norm.rvs(
    loc=df_co2_model['CO2'].values[cutoff_int], scale=4*df_co2['unc'].values[i1ohc],
